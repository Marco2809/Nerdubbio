...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Nerdubbio" },
      { property: "og:title", content: "Nerdubbio — Nerdacolo del binge" },
      { property: "og:description", content: "Non sai cosa vedere stasera? È letteralmente il nostro lavoro." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/png", sizes: "32x32", href: `/favicon.png?v=${av}` },
      { rel: "icon", type: "image/png", sizes: "192x192", href: `/icon-192.png?v=${av}` },
      { rel: "icon", type: "image/svg+xml", href: `/favicon.svg?v=${av}` },
      { rel: "manifest", href: "/manifest.webmanifest" },
      { rel: "apple-touch-icon", sizes: "180x180", href: `/apple-touch-icon.png?v=${av}` },
